...
<div id="details" style="width: 95%">	
	...
	<span ><h4>Select Product Range: </h4> <select ng-model="np.pro.selectProduct" ng-options="x.product for x in products" ng-value="x"></select></span>
	<div ng-show="np.pro.selectProduct">
	...
	<span ng-hide="np.pro.selectProduct.id == 2"> <p>Alias: <input placeholder="Alias" type="text" ng-model="np.pro.tool_alias" autofocus="autofocus" style="width:50%" /></p></span>
	<span ng-show="np.pro.selectProduct.id == 2"><p>Select Alias: <select ng-model="np.pro.selectedAlias" ng-options="x.tool_ref for x in np.list"></select></p>	</span>
...
<div style="border: 2px dashed #a2a2a2; padding:5px; background-color:#d4d4d4; border-radius: 5px">
	...
	<div ng-show="np.pro.selectProduct.id == '1'">
...
<div ng-show="np.pro.selectProduct.id == 2">	
...
<div ng-show="np.pro.selectProduct.id == 3">		
...
<div ng-show="np.pro.selectProduct.id== 4">
		<p><strong>Internals </strong></p>
	L: <input placeholder="Length" type="number" ng-model="np.pro.length"  autofocus="autofocus" />
W: <input placeholder="Width" type="number" ng-model="np.pro.width" size="5" autofocus="autofocus" />
H: <input placeholder="Height" type="number" ng-model="np.pro.height" size="5" autofocus="autofocus"/>
...
<div ng-show="np.pro.selectProduct.id == '5'">
Select Alias: 
<p><select ng-model="selectedTool" ng-options="x.tool_ref for x in np.list"></select></p>
