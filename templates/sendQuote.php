...
$greeting = 'We are delighted to quote for your packaging requirements as follows;';
...
<p>'.$greeting.'</p>
		...
		<table ng-model="send_quote" style="margin-bottom: 20px;table-layout:fixed; width: 100%">
			...
			<tr>
				...
				<th colspan="4" scope="colgroup"style="border:1px solid black;border:1px solid black; text-align: center; padding: 8px;"><h3>Quotation</h3></th>
...
'.$footer.'
		...
		$toolingDal->quoteSent($quote_ref,$comment1,$comment2,$comment3);
